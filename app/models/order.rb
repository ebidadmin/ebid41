class Order < ActiveRecord::Base
  attr_accessible :user_id, :company_id, :entry_id, :ref_no, :ref_name, :deliver_to, 
  :address1, :address2, :contact_person, :phone, :fax, :instructions, :status, :buyer_ip, 
  :items_count, :order_total, :created_at, :seller_id, :seller_company_id, :seller_confirmation, 
  :confirmed, :delivered, :due_date, :paid_temp, :paid, :cancelled, :ratings_count, 
  :entry_attributes
