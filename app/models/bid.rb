class Bid < ActiveRecord::Base
  attr_accessible :user_id, :entry_id, :line_item_id, :car_brand_id, :amount, :quantity, 
  :total, :bid_type, :bid_speed, :lot, :status, :ordered, :order_id, :delivered, :paid, 
