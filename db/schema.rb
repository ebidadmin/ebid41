...
ActiveRecord::Schema.define(:version => 20121011033737) do
  ...
  create_table "entries", :force => true do |t|
    ...
    t.datetime "redecided"
    t.date     "expired"
    t.boolean  "chargeable_expiry"
  ...
  add_index "orders", ["seller_company_id"], :name => "index_orders_on_seller_company_id"
  ...
  add_index "variances", ["var_company_id"], :name => "index_variances_on_var_company_id"
